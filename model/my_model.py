    ...
    def _build_syn_ext5_listwise(self):
        ...
        with tf.name_scope('list_wise'):
            ...
            with tf.variable_scope('synatic_extract') as syn_ext_l:
                ...
                self.ques_syn = ques_syn = tf.layers.dropout(self.convXd_listwise(q_syn_extractor,ques_h,self._ques_align_len),rate=0.8)
                ans_syn = tf.layers.dropout(self.convXd_listwise(a_syn_extractor,ans_h,self._ans_align_len),rate=0.8)
                print('ans_syn: ',ans_syn.shape)
